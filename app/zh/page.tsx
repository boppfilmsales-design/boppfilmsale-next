...
export default async function HomeZhPage() {
        ...
        <div className="wrap">
          <div className="hero-content">
            ...
            <div className="hero-lang-switcher">
              <a href="/" className="lang-btn-hero" title="English Version">
      ...
      <section className="categories" id="products">
        <div className="wrap">
          ...
          <div className="cat-grid">
            <Link href="/zh/products?category=BOPP" className="cat-card">
              <div className="cat-icon">🎞️</div>
              <h3>BOPP 薄膜</h3>
              <p>双向拉伸聚丙烯薄膜，包括平膜、热封膜、消光膜、镀铝膜、珠光膜等。</p>
            </Link>
            <Link href="/zh/products?category=BOPET" className="cat-card">
              <div className="cat-icon">🌟</div>
              <h3>BOPET 薄膜</h3>
              <p>优质聚酯薄膜，适用于电气绝缘、电容器、多色印刷复合基材等领域。</p>
            </Link>
            <Link href="/zh/products?category=胶粘带和胶水" className="cat-card">
              <div className="cat-icon">📦</div>
              <h3>胶粘带与胶水</h3>
              <p>封箱胶带大卷、美纹纸胶带、双面胶带、丙烯酸涂布胶水等。</p>
            </Link>
            <Link href="/zh/products?category=涂布膜" className="cat-card">
              <div className="cat-icon">🛡️</div>
              <h3>涂布薄膜</h3>
              <p>PVDC 涂布(K膜)、丙烯酸涂布等功能性涂布膜，阻隔性能优异。</p>
            </Link>
            <Link href="/zh/products?category=中间体" className="cat-card">
              <div className="cat-icon">🔬</div>
              <h3>中间体产品</h3>
              <p>伽马丁内酯等精细化工中间体，纯度高、供应稳定。</p>
            </Link>
            <Link href="/zh/products?category=其他" className="cat-card">
              <div className="cat-icon">📦</div>
              <h3>其他材料</h3>
              <p>CPP、BOPA、POF、PE、PVC 薄膜及袋子、纸制品、各类包装耗材。</p>
            </Link>
            <Link href="/zh/products?category=机器设备和电子产品" className="cat-card">
              <div className="cat-icon">⚙️</div>
              <h3>机器设备与电子产品</h3>
              <p>工业分切机、高速涂布机、复合机、收缩设备等自动化包装机械。</p>
            </Link>
            <Link href="/zh/products?category=防疫用品" className="cat-card">
              <div className="cat-icon">🏥</div>
              <h3>防疫用品</h3>
          ...
          <div className="view-all">
            <Link href="/zh/products" className="btn btn-primary">查看所有分类</Link>
          </div>
        </div>
      </section>
            ...
            {news.map((n) => (
              <article key={n.id} className="news-card">
                ...
                <div className="news-content">
                  ...
                  <h3><Link href={`/zh/news/${n.id}`}>{n.title}</Link></h3>
                  <p>阅读完整文章了解我们的最新动态与行业洞察。</p>
                  <Link href={`/zh/news/${n.id}`} className="news-link">阅读全文 →</Link>
                </div>
              </article>
            ))}
          </div>
          <div className="view-all" style={{ marginTop: 48 }}>
            <Link href="/zh/news" className="btn btn-outline">查看所有新闻</Link>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="contact-grid">
            ...
            <div className="contact-form">
              <form action="/zh/feedback" method="POST">
