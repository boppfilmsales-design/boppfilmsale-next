        ...
        <div className="wrap">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Anhui Eastern Progress Imp. & Exp. Co., Ltd (AEC GROUP) delivers top-tier BOPP, BOPET, POF films, thermal ribbons, labels, and machinery solutions to over 80 countries.
            </p>
      ...
      <section className="categories" id="products">
        <div className="wrap">
          ...
          <div className="cat-grid">
            <Link href="/en/products?category=BOPP" className="cat-card">
            ...
            <Link href="/en/products?category=BOPET" className="cat-card">
          ...
          <div className="view-all">
            <Link href="/en/products" className="btn btn-primary">View All Categories</Link>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="about-grid">
            <div className="about-content">
              ...
              <p className="section-subtitle">Anhui Eastern Progress Imp. & Exp. Co., Ltd. - Your trusted partner in packaging solutions.</p>
              <p className="about-desc">
                Established in Hefei, Anhui Province, AEC GROUP (Anhui Eastern Progress) has grown from a specialized packaging film exporter into an industrial material supply chain leader.
              </p>
              <p className="about-desc">
      ...
      <section className="news" id="news">
        <div className="wrap">
          ...
          <div className="view-all" style={{ marginTop: 48 }}>
            <Link href="/en/news" className="btn btn-outline">View All News</Link>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="contact-grid">
            ...
            <div className="contact-form">
              <form action="/en/feedback" method="POST">
